...
$smtp.Credentials = New-Object System.Net.NetworkCredential("suleymanabdel@outlook.com", "sfsef3fwr434$");
$smtp.EnableSsl = $true
$Message.From = "suleymanabdel@outlook.com"
$Message.To.Add("suleymanabdel@outlook.com")
